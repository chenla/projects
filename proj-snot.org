...
well.  This is very true, Liebnitz formulated the Calculus at the same
time as Newton.  Newton ended up getting the credit, though it was
Liebnitz's notation that was adopted over Newton's.  But it should be
noted that Newton dedicated as much of his astonishing intellect to
the pursuit of alchemy as to calculus or physics and mechanics.  Time
spent thinking about something does not ensure success, or if the
results are accepted as a step forward or dismissed as a crackpot dead
end.  At the end of the day I can only take solace that I heeded
Richard Hamming's admonishment that, "if you don't work on important
problems, you can't do important work."
