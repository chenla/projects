...
scenarios because which is infinite.  Limiting assertions to what is
...
to fictional uiverses as well -- that facts can be established in any
internally consistent universe, be it real or imagined.


         now talk about fnords....


** is this a viable business?

Verisign which today has a 2017 market cap of nearly $8B was built on
a very small single aspect of what fnord will be able to offer

in fact because fnord is distributed -- there will  be many different
multi-billion dollar companies that can be based on this platform

the scale we are talking about is in the same magnitude as the entire
