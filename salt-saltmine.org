...
every wikipedia article will be an itfs literate-epub
...
so when you cite a wikipedia article, the version you cite
is bundled with your paper -- eventually all papers and
...
images and they will retail their provenance.
